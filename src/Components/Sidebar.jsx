...
const activeStyle = ({ isActive }) => ({
  ...
  const toggleNav = () =>{
    ...
    return(
        <div>
        <div className="min-h-screen w-[200px]  hidden md:flex flex-col items-center pt-16">
            ...
            {
                navOpen ? <div className="min-h-screen w-[250px] flex md:hidden flex-col items-center pt-16 fixed bg-[#111111] border-r border-[#191919]">
                <h1 className="text-[#6E56CF] font-semibold text-sm h-16 w-full flex justify-start items-center pl-3 ">GENERAL</h1>
