...
export default function TooltipSection() {
  return (
    <div className="py-20 flex flex-col gap-5 border-b">
      ...
      <div className="flex flex-col md:flex-row justify-around items-center gap-4 mt-20">
        <div className=" flex flex-col justify-around items-center gap-2 h-52 ">
          ...
          <h1 className="bg-[#353535] text-[14px] p-4 rounded-md">{`<Tooltip title="Archive notes" color="blue">
                        <TooltipClick>
                            <Button>Click here</Button>
                        </TooltipClick>
        ...
        <div className=" flex flex-col justify-around items-center gap-2 h-52 ">
          ...
          <h2 className="text-xl mt-5 font-semibold">Code:</h2>
          <h1 className="bg-[#353535] text-[14px] p-4 rounded-md">{`<Tooltip title="Archive notes" color="purple" style="bold">
                        <TooltipClick>
                            <Button>Click here</Button>
                        </TooltipClick>
                        <TooltipPopup>Lorem ipsum dolor sit amet consectetur adipisicing elit oluptatum tenetur.</TooltipPopup>
