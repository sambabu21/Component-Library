    ...
    return (
        <div className="py-40 w-full flex flex-col justify-center items-center bg-[#191919]">
            <div className="max-w-3xl flex flex-col justify-center items-start gap-20 ">
                ...
                <Link to="/components" className="w-[250px] h-[50px] flex justify-center items-center text-white font-semibold hover:shadow-[0px_0px_10px_7px_#291F43]  border border-[#6E56CF] rounded-full">Explore components →</Link>
            </div>
        </div>
    )
}