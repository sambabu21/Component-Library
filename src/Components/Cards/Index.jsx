        ...
        <div className="py-20 flex flex-col gap-5 border-b">
            ...
            <div className="flex flex-col md:flex-row justify-around items-center gap-5">
                <div className=" flex flex-col justify-around items-center gap-2"> 
                    ...
                    <h1 className="bg-[#353535] p-2 rounded-md">{`<Card title="easy deployment" iconUrl={uploadImg}>Ac tincidunt sapien vehicula erat auctor pellentesque rhoncus. Et magna sit morbi lobortis.</Card>`}</h1>
                </div>
                <div className=" flex flex-col justify-around items-center gap-2"> 
                    ...
                    <h2 className="text-xl mt-5 font-semibold">Code:</h2>
                    <h1 className="bg-[#353535] p-2 rounded-md">{`<Card title="Robust deployment" iconUrl={tickImg}>Ac tincidunt sapien vehicula erat auctor pellentesque rhoncus. Et magna sit morbi lobortis.</Card>`}</h1>
                </div>
            </div>
