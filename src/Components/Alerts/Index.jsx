  ...
  return (
    <div className="bg-[#111927] flex justify-center items-center">
      <div className="w-full sm:w-[80vw] flex flex-col items-start p-20 gap-10">
        ...
        <div className="w-full h-[250px] glass flex flex-col justify-center items-center gap-20">
        ...
        <div className="w-full glass flex flex-col justify-center items-center gap-10 py-10">
